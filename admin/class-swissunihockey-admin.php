 ...
 * @subpackage Swissunihockey/admin
 */
...
class Swissunihockey_Admin {
	...
	public function enqueue_styles() {
		 ...
		 * defined in Swissunihockey_Loader as all of the hooks are defined
		 * in that particular class.
		 *
		 * The Swissunihockey_Loader will then create the relationship
		 * between the defined hooks and the functions defined in this
		 * class.
		 */

		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/swissunihockey-admin.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'js/swissunihockey-admin.js', array( 'jquery' ), $this->version, false );
